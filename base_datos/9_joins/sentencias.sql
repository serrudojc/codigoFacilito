...
-- LEFT JOIN
-- No posee llave primaria, pero posee dos foraneas. Que libro fue prestado a q usuarios
-- que usuario ha prestado que libros.
-- en que fecha el libro fue prestado
...
-- cada vez que insertemos un registro en la tabla anterior, vamos a disminuir el stock de los libros
